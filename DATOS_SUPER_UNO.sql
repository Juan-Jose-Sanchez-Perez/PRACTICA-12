...
INSERT INTO Proveedores (nombre, telefono, contacto) VALUES
  ('Proveedor Bebidas Energéticas',    '5551234003', 'contacto_energeticas@gmail.com'),
  ('Proveedor Jugos Jumex',            '5551234004', 'jumex.contacto@outlook.com'),
  ('Proveedor Pan Bimbo',              '5551234005', 'bimbo_info@gmail.com'),
  ('Proveedor Cervezas Modelo',        '5551234006', 'modelo.cervezas@outlook.com'),
...
INSERT INTO Clientes (telefono, nombre, correo, direccion) VALUES
  ('9613456780','Miguel Torres',     'miguel.torres@gmail.com',    'Calle Olivo No. 202'),
  ('9614567890','Sofía Hernández',   'sofia.hernandez@outlook.com','Av. Insurgentes 345'),
  ('9615678901','Diego Martínez',    'diego.martinez@gmail.com',   'Calle Lago No. 78'),
  ('9616789012','Lucía Ramos',       'lucia.ramos@outlook.com',    'Av. Reforma 100'),
...
INSERT INTO Empleados (nombre, puesto, salario, fecha_contratacion, turno) VALUES
  ('Alejandro Pérez',   'Bodeguero',               7500.00, '2022-05-15', 'Matutino'),
  ('María Castillo',    'Gerente de Ventas',       8500.00, '2023-07-10', 'Vespertino'),
  ('Carlos Rivera',     'Personal de Limpieza',    7200.00, '2024-11-01', 'Nocturno'),
  ('Ana Morales',       'Auxiliar de Ventas',       7800.00, '2025-02-28', 'Matutino'),
